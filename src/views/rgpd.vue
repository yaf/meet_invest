<template>
  <div class="rgpd">
      <p>
Politique de Confidentialité et de Protection de la Vie Privée du site internet Welcometothejungle.com
Version en date du 01 Novembre 2017
Nous vous invitons à lire avec attention le présent document (ci-après, la « Politique de Confidentialité » ou les « Règles de Confidentialité »). Pour toute question concernant ce document et, d’une manière générale, sur la collecte et le traitement de vos informations personnelles par la société Coruscant, n’hésitez pas à nous contacter via l’adresse e-mail suivante : 
privacy@wttj.co   

1. Préambule et champ d’application
La société Coruscant est soucieuse de préserver la confidentialité de vos informations personnelles et attache une grande importance à la protection de la vie privée des utilisateurs de ses services.
...
La Politique de Confidentialité fait partie intégrante des Conditions générales d’utilisation et de vente du site Welcometothejungle.co. Elle s’applique aux utilisateurs de notre site quelle que soit leur catégorie : particulier, non-professionnel, professionnel, candidat ou encore recruteur.

Nos Règles de Confidentialité ne s’appliquent pas aux services proposés par des sociétés tierces, exploitant des sites web partenaires de la société Coruscant ou d’autres sites web accessibles à partir de nos services. Nous ne sommes pas responsables de la façon dont ces sites utilisent vos Données Personnelles.

2. Acceptation et mise à jour de nos Règles de Confidentialité
En cochant en ligne la case “J’ai lu et j’accepte la Politique de Confidentialité du site Welcometothejungle.co”, vous (en qualité d’Utilisateur) confirmez avoir pris connaissance et accepter sans restriction ni réserve les présentes. Si vous êtes en désaccord avec l’un de ses termes, vous êtes libre de ne pas ou ne plus utiliser nos services (en cas de modification des termes de la Politique).

Nos Règles de Confidentialité peuvent être amenées à changer, étant précisé que toute diminution de vos droits ne saurait être appliquée sans votre consentement. Aussi, nous publierons les nouvelles versions de la Politique de Confidentialité sur le site Welcometothejungle.co et nous vous alerterons au moyen d’un email vous offrant la possibilité de les consulter.

D’une manière générale, la Politique de Confidentialité est toujours facilement accessible via les différentes pages du site Welcometothejungle.co.

3. Responsable de traitement des Données Personnelles
Le traitement des Données Personnelles des Utilisateurs inscrits au site Welcometothejungle.co est soumis à la loi française, notamment à la loi n° 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, modifiée (dite Loi Informatique et Libertés).

Le « responsable de traitement », tel que défini par ladite Loi, des Données Personnelles des Utilisateurs du site Welcometothejungle.co est : Société Coruscant - RCS Paris sous le n°802 162 628 - 16 rue du mail – 75002 Paris – France.

En cette qualité, nous nous engageons, dans le cadre de nos activités, à respecter les dispositions de ladite Loi, et à effectuer un traitement licite, loyal et transparent de vos Données Personnelles. A savoir notamment à réaliser un traitement de données pour des finalités déterminées, explicites et légitimes, sans être traitées ultérieurement de manière incompatible avec ces finalités, pendant une durée qui n’excède pas la durée nécessaire aux finalités pour lesquelles elles sont collectées et traitées.

Enfin, nous vous informons que le traitement des Données Personnelles des Utilisateurs du site Welcometothejungle.co a dûment été déclaré à la Commission Nationale Informatique et Libertés (dite ‘CNIL’), sous le numéro 1811611.

4. Catégories de Données Personnelles collectées et traitées via le site Welcometothejungle.co
a) Données personnelles que vous communiquez à la société Coruscant
Nous collectons les Données Personnelles des internautes qui souhaitent : en savoir plus sur nos activités (via le formulaire de contact), recevoir nos actualités, postuler aux offres d’emploi mis en ligne sur le site Welcometothejungle.co et acheter des produits sur notre site (formulaires d’inscription et de passation de commande).

L’accès et l’utilisation du site Welcometothejungle.co impliquent la collecte et le traitement de vos Données Personnelles, à savoir notamment le nom, prénom, numéro de téléphone, adresses e-mail et postale, CV, photographie, etc. Certaines informations sont obligatoires (suivi d’un astérisque) et d’autres facultatives comme indiqué dans le formulaire.

b) Cookies
Un « cookie » (ou « traceur ») est un témoin de connexion qui désigne un fichier texte susceptible d’être enregistré dans un espace dédié du disque dur de votre terminal (ordinateur, tablette, ou smartphone), à l’occasion de la consultation d’un service accessible en ligne. Un cookie permet à son émetteur d’identifier le terminal dans lequel il est enregistré, pendant la durée de validité ou d’enregistrement du cookie. Le cookie ne permet donc pas de vous identifier en tant que tel ; il sert à enregistrer vos informations de navigation sur le site Welcometothejungle.co.

Lors de vos visites sur le site Welcometothejungle.co, des informations relatives à votre navigation sont susceptibles d’être enregistrées dans des fichiers “Cookies” installés sur votre terminal, sous réserve des choix que vous aurez exprimés concernant les cookies et que vous pouvez modifier à tout moment. Ces cookies permettent une navigation personnalisée de l’Utilisateur et sont également utilisés à des fins analytiques (mesures d’audience).

Vous serez averti de l’existence des cookies et de leur(s) finalité(s) dès votre connexion au site Welcometothejungle.co, par la présence d’un bandeau d’information placé en bas ou en haut de la page d’accueil.
...
Enfin, il convient de distinguer les cookies que nous émettons sur notre site Welcometothejungle.co de ceux émis par des tiers. A ce titre, sachez que des cookies peuvent être placés de temps à autres sur certaines pages du site Welcometothejungle.co par des tiers (annonceurs publicitaires ou autres). C’est le cas par exemple pour les cookies du réseau social Facebook. Nous vous informons que nous n’exerçons aucun contrôle sur l’utilisation de cookies par les tiers.

5. Conditions d’utilisation des Données Personnelles
a) Finalités de la collecte et du traitement de vos Données Personnelles
Les Données Personnelles des Utilisateurs sont collectées et traitées selon des finalités définies et précises, telle que : (i) Fournir et gérer nos services ; (ii) Gérer le traitement de vos candidatures à destination des Recruteurs et de vos commandes de produits ; (iii) Communiquer avec les Utilisateurs et améliorer la qualité de nos services, à savoir répondre à vos questions et vous informer de nos actualités ; (iv) Lutter contre la fraude en ligne ; et (v) Résoudre tout litige éventuel ou régler tout problème dans le cadre de l’utilisation de nos services.

Toute utilisation de Données Personnelles dans un but autre que ceux exposés ci-dessus dans nos Règles de Confidentialité nécessitera votre accord préalable exprès.

b) Durée de conservation de vos Données Personnelles
...
6. Partage d’informations avec des tiers
...
Faire appliquer la Politique de Confidentialité et les Conditions générale de vente du site Welcometothejungle.co en vigueur, y compris pour constater d’éventuels manquements à celles-ci ;

Se prémunir contre toute atteinte aux droits, aux biens ou à la sécurité de la société Coruscant et de ses utilisateurs, en application et dans le respect de la loi.
...
À cet effet, la société Coruscant et ses prestataires techniques et d’hébergement ont déployé des mesures appropriées pour assurer l’intégrité, la confidentialité et la sécurité de vos Données Personnelles (notamment via le respect de normes ISO). Nous ne pouvons cependant assurer que vos communications et autres Données Personnelles ne seront pas interceptées ou divulguées par un tiers.

Enfin, nous vous informons que vos Données Personnelles sont stockées sur des serveurs situés dans l’Union européenne.

7. Respect des droits des Utilisateurs du site Welcometothejungle.co
Vous disposez d’un droit d’accès (ex : vérifier les données vous concernant que nous conservons), d’un droit de rectification (mettre à jour ou corriger vos données), et d’un droit de suppression (ex : fermeture de votre compte personnel) de vos Données Personnelles, ainsi qu’un droit d’opposition à la collecte et au traitement de tout ou partie de celles-ci à des fins de prospection commerciale, y compris de profilage dans la mesure où il est lié à une telle prospection.
